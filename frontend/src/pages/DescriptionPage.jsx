...
const DescriptionPage = () => {
  ...
  return <div className='px-4 lg:px-12 py-4 h-auto flex flex-col md:flex-row items-start justify-between gap-4 '>
      {Podcasts && <><div className='w-2/6 flex items-center justify-center md:justify-start md:items-start'>
        ...
        <div className="w-4/6"><div className="text-4xl font-semibold">{Podcasts.title}</div>
        <h4>{Podcasts.description}</h4>
        <div>
