    ...
    return (
        ...
        <div className='mt-12 w-full flex flex-col lg:flex-row items-end justify-between'>
            <div className='flex flex-col items-center lg:items-start justify-center '>
                <p className='text-xl font-semibold text-center lg:text-start'> Listen To The Most Popular Podcasts On Just One Platform -
                 <b>PODSTREAM</b></p>
                 <button className='px-6 py-4 bg-green-900 text-white font-semibold rounded-full mt-6 lg:mt-8'>Login To Listen</button>
                 </div>
            <div className='mt-6 lg:mt-0'><p className='text-zinc-600 font-bold text-center lg:text-end '>Our App Contains More Than 2000 Podcasts For You</p></div>
